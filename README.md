...
https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/install-post.sh
...
````
wget https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/install-hetzner.sh -c -O install-hetzner.sh && chmod +x install-hetzner.sh
./install-hetzner.sh
````
* Reboot
...
```
wget https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/network-configure.sh -c -O network-configure.sh && chmod +x network-configure.sh
...
* Installation script (URL): https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/install-post.sh
...
```
wget https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/createzfs.sh -c -O createzfs.sh && chmod +x createzfs.sh
...
```
wget https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/xshok_slog_cache-2-zfs.sh -c -O xshok_slog_cache-2-zfs.sh && chmod +x xshok_slog_cache-2-zfs.sh
...
```
curl -O https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/debian9-2-proxmox5.sh && chmod +x debian9-2-proxmox5.sh
...
```
curl https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/pve-enable-lxc-docker.sh --output /usr/sbin/pve-enable-lxc-docker && chmod +x /usr/sbin/pve-enable-lxc-docker
...
```
wget https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/lvm-2-zfs.sh -c -O lvm-2-zfs.sh && chmod +x lvm-2-zfs.sh
./lvm-2-zfs.sh
```
...
```
wget https://raw.githubusercontent.com/tiborpilz/xshok-proxmox/master/tincvpn.sh -c -O tincvpn.sh && chmod +x tincvpn.sh
./tincvpn.sh -h
```
